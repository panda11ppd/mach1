...
require.config({
	baseUrl: TBUI.STATIC + '/js',
	urlArgs: 'ver=' + TBUI.VERSION,
	paths: {
		...
		'tipsy': 'libs/tipsy',
		'pasteimage': 'libs/pasteimage',
		'jsonpi': 'libs/jquery.jsonpi',
		'tinymce': 'http://themebetter.com/static/tinymce/tinymce.min',
		'ueditor.config': 'http://themebetter.com/static/ueditor/ueditor.config',
		'ueditor.all.min': 'http://themebetter.com/static/ueditor/ueditor.all.min',
		'ueditor.lang': 'http://themebetter.com/static/ueditor/lang/zh-cn/zh-cn',
		'theme': 'theme',
		'vip': 'vip',
		'act': 'act',
		'user': 'user'
